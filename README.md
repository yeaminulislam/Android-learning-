...
v1.1.1 থেকে অ্যাপে **ক্র্যাশ-রিপোর্ট** বিল্ট-ইন আছে:

- কোনো এররে অ্যাপ বন্ধ হলে লগটি অ্যাপের ভেতরেই সংরক্ষিত হয়।
- **পরেরবার অ্যাপ খুললে** একটি ডায়ালগে সেই লগ দেখাবে — **"লগ কপি করুন"** চেপে ডেভেলপারকে ([ইস্যুতে](https://github.com/yeaminulislam/Android-learning-/issues)) পাঠিয়ে দিলে দ্রুত ফিক্স পাবেন।
