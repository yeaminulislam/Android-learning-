...
মোট **দুটি বিল্ড-বাগ** পাওয়া গেছে। দুটোই ঠিক করা হয়েছে, এবং এখন প্রতিটি বিল্ডের
পরে `tools/verify_apk.py` স্বয়ংক্রিয়ভাবে যাচাই করে — কোনোটি ফেল করলে বিল্ড ব্যর্থ হয়।
...
### এখন প্রতিটি বিল্ডে যা যাচাই হয় (`tools/verify_apk.py`)
