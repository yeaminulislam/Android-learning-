...
মোট **তিনটি বাগ** পাওয়া গেছে — দুটি বিল্ড-পাইপলাইনে, একটি SQL-এ। তিনটিই ঠিক করা
হয়েছে। এখন প্রতিটি বিল্ডের পরে `tools/verify_apk.py` প্যাকেজিং যাচাই করে, আর
